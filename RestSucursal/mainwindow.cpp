...
{
    ui->setupUi(this);
    conexion.setHostName ( "DESKTOP-FK0QTO8" ) ; // establece el nombre de tu host
    conexion.setDatabaseName ( "DRIVER={SQL SERVER};SERVER=DESKTOP-FK0QTO8;DATABASE=Restaurante" ) ; // establece el nombre de tu base de datos
